...
export default function HistoryDataPage() {
  ...
  const [chartConfig, setChartConfig] = useState<ChartConfig | null>(() => getChartConfigFromParams());
      ...
      <div className="flex-1 px-6 pb-6">
        <TwoColumnPage>
          ...
          <div className="space-y-3">
            <ChartForm onSubmit={handleFormSubmit} loading={isLoading} initialValues={chartConfig || undefined} />
            ...
            {process.env.NODE_ENV === 'development' && chartConfig && (
              <Container>
                <div className="space-y-2">
                  ...
                  <Text size="xsmall" className="text-ui-fg-muted break-all font-mono">
